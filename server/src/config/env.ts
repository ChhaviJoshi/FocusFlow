...
function requireEnvInProd(key: string): string {
  const value = process.env[key];
...
export const env = {
  ...
  // Slack OAuth (P2)
  slackClientId: requireEnvInProd("SLACK_CLIENT_ID"),
  slackClientSecret: requireEnvInProd("SLACK_CLIENT_SECRET"),
  slackRedirectUri: requireEnvInProd("SLACK_REDIRECT_URI"),

  // Jira OAuth (P2)
  jiraClientId: requireEnvInProd("JIRA_CLIENT_ID"),
  jiraClientSecret: requireEnvInProd("JIRA_CLIENT_SECRET"),
  jiraRedirectUri: requireEnvInProd("JIRA_REDIRECT_URI"),
